 ...
 */
class HootKit_Slider_Postcarousel_Widget extends HK_Widget {
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$slider_template = hoot_get_widget( 'slider-carousel', false, 'post' );
		...
		if ( apply_filters( 'hootkit_display_widget_extract_overwrite', false, 'slider-postcarousel' ) ) extract( $instance, EXTR_OVERWRITE ); else extract( $instance, EXTR_SKIP );
		// Fire up the template
		if ( is_string( $slider_template ) && file_exists( $slider_template ) ) include ( hootkit()->dir . 'widgets/postcarousel/view-setup.php' );
	}
