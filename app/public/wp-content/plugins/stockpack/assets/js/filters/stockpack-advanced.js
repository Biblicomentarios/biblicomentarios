const StockpackAdvanced = wp.media.View.extend( /** @lends wp.media.view.Search.prototype */{
	tagName: 'div',
	className: 'stockpack-advanced',
	id: 'stockpack-advanced-area',

	attributes: {},

	/**
	 * @return {StockpackAdvanced} Returns itself to allow chaining
	 */
	initialize() {
		this._views = {};
		...
		this.link.$el.addClass( 'stockpack-filters-trigger' );
		this.filters.$el.addClass( 'stockpack-filters-container' );
...
export default StockpackAdvanced;
