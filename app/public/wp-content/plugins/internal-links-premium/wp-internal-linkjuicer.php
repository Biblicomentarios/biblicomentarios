 ...
 *
 * @wordpress-plugin
 * Plugin Name: Internal Link Juicer (Pro)
 ...
 *
 * @fs_premium_only /admin/js/gutenberg,/admin/js/ilj_ajax_index_rebuild.js,/admin/js/ilj_custom_links.js,/admin/css/ilj_index_rebuild.css,/backend/menupage/customlinks.php,/backend/indexrebuildnotifier.php,/command,/core/shortcodes.php,/database/termmeta.php,/helper/import.php,/helper/url.php,/includes/wp-cli.php,/posttypes/customlinks.php
 */
namespace ILJ;
...
if ( function_exists( '\\ILJ\\ilj_fs' ) ) {
    ilj_fs()->set_basename( true, __FILE__ );
    return;
} else {
    function ilj_fs()
    {
