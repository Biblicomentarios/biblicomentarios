...
global $title, $hook_suffix, $current_screen, $wp_locale, $pagenow, $wp_version,
		...
		$license_type = Swift_Performance::license_type();
?>
<!DOCTYPE html>
...
<body class="wp-core-ui swift-setup">
	<div id="swift-performance-wrapper" class="swift-setup-wrapper">
		<div class="swift-performance-header">
            ...
            <div class="swift-setup-slide<?php echo($license_type !== 'offline' && Swift_Performance::check_option('purchase-key', '') ? ' active' : '');?>" id="purchase-key">
                  <h2><?php echo sprintf(esc_html__('Set purchase key', 'swift-performance'), SWIFT_PERFORMANCE_PLUGIN_NAME);?></h2>
                  <div class="purchase-key-inner" data-animation-in="fadeIn" data-animation-out="fadeOut">
                        ...
                        <div class="swift-buttonset swift-pull-right">
                              ...
                              <a href="#" data-swift-setup-slide="dashboard" class="swift-btn swift-btn-black"><?php esc_html_e('Skip', 'swift-performance')?></a>
                        </div>
                  </div>
            </div>
            <div class="swift-setup-slide<?php echo($license_type !== 'offline' && Swift_Performance::check_option('purchase-key', '') ? '' : ' active');?>" id="dashboard">
                  <h2><?php echo sprintf(esc_html__('Setup', 'swift-performance'), SWIFT_PERFORMANCE_PLUGIN_NAME);?></h2>
            ...
            <div class="swift-setup-slide" id="import">
                  <div data-animation-in="fadeIn">
                        <a href="#" data-swift-setup-slide="dashboard" class="swift-btn swift-btn-black"><i class="fas fa-chevron-left"></i> <?php esc_html_e('Back', 'swift-performance')?></a>
				<br><br>
                        <h2><?php esc_html_e('Import Settings', 'swift-performance');?></h2>
                        <div class="swift-autoconfig-welcome">
                              <div class="swift-setup-info"><?php echo esc_html_e('Upload previously exported configuration file.', 'swift-performance'); ?></div>
                        ...
                        <ul class="swift-preset-list">
                              <li class="swift-preset-list-item">
                                    <div class="swift-preset-title">
                                          ...
                                          <h3><?php esc_html_e('Simple Caching', 'swift-performance');?></h3>
                                    </div>
                                    ...
                                    <div class="swift-buttonset swift-pull-right">
                                          <a href="<?php echo esc_url(add_query_arg(array('page' => SWIFT_PERFORMANCE_SLUG), admin_url('tools.php')));?>" class="swift-setup-use-preset swift-btn swift-btn-brand" data-preset="simple"><?php esc_html_e('Use Preset', 'swift-performance');?></a>
                                    </div>
                              ...
                              <li class="swift-preset-list-item">
                                    <div class="swift-preset-title">
                                          ...
                                          <h3><?php esc_html_e('Limited Hosting', 'swift-performance');?></h3>
                                    </div>
                                    ...
                                    <div class="swift-buttonset swift-pull-right">
                                          <a href="<?php echo esc_url(add_query_arg(array('page' => SWIFT_PERFORMANCE_SLUG), admin_url('tools.php')));?>" class="swift-setup-use-preset swift-btn swift-btn-brand" data-preset="limited"><?php esc_html_e('Use Preset', 'swift-performance');?></a>
                                    </div>
                              ...
                              <li class="swift-preset-list-item">
                                    <div class="swift-preset-title">
                                          ...
                                          <h3><?php esc_html_e('Moderate Optimization', 'swift-performance');?></h3>
                                    </div>
                                    ...
                                    <div class="swift-buttonset swift-pull-right">
                                          <a href="<?php echo esc_url(add_query_arg(array('page' => SWIFT_PERFORMANCE_SLUG), admin_url('tools.php')));?>" class="swift-setup-use-preset swift-btn swift-btn-brand" data-preset="moderate"><?php esc_html_e('Use Preset', 'swift-performance');?></a>
                                    </div>
                              ...
                              <li class="swift-preset-list-item">
                                    <div class="swift-preset-title">
                                          ...
                                          <h3><?php esc_html_e('Improved Optimization', 'swift-performance');?></h3>
                                    </div>
                                    ...
                                    <div class="swift-buttonset swift-pull-right">
                                          <a href="<?php echo esc_url(add_query_arg(array('page' => SWIFT_PERFORMANCE_SLUG), admin_url('tools.php')));?>" class="swift-setup-use-preset swift-btn swift-btn-brand" data-preset="improved"><?php esc_html_e('Use Preset', 'swift-performance');?></a>
                                    </div>
                              ...
                              <li class="swift-preset-list-item">
                                    <div class="swift-preset-title">
                                          ...
                                          <h3><?php esc_html_e('Maximum Optimization', 'swift-performance');?></h3>
                                    </div>
                                    ...
                                    <div class="swift-buttonset swift-pull-right">
                                          <a href="<?php echo esc_url(add_query_arg(array('page' => SWIFT_PERFORMANCE_SLUG), admin_url('tools.php')));?>" class="swift-setup-use-preset swift-btn swift-btn-brand" data-preset="max"><?php esc_html_e('Use Preset', 'swift-performance');?></a>
                                    </div>
            ...
            <div class="swift-setup-slide" id="autoconfig">
                  <div data-animation-in="fadeIn">
                        <h2><?php _e('Autoconfig', 'swift-performance');?></h2>
                        <div class="swift-autoconfig-welcome">
            ...
            <div class="swift-setup-slide" id="cloudflare">
				...
				<div class="swift-p-row" id="cloudflare-token-container">
                              <label for="cloudflare-token">
                                    <?php esc_html_e('Cloudflare Auth Token', 'swift-performance');?>
                              </label><br><br>
                              <input type="text" name="cloudflare-token" id="cloudflare-token" value="<?php echo esc_attr(Swift_Performance::get_option('cloudflare-token'));?>">
                              <p><em><?php esc_html_e('Cloudflare authentication token.', 'swift-performance')?> <a href="https://support.cloudflare.com/hc/en-us/articles/200167836-Managing-API-Tokens-and-Keys" target="_blank"><?php esc_html_e('Managing API Tokens','swift-performance');?></a></em></p>
                        </div>
                        <div class="swift-buttonset swift-pull-right">
            ...
            <div class="swift-setup-slide has-bg" id="finish">
                  <h2><?php esc_html_e('YAY!', 'swift-performance'); ?></h2>
                  <div data-animation-in="fadeIn">
				<h3><?php esc_html_e('Your website is ready!', 'swift-performance'); ?></h3>
                        <p>
                        	<em><?php _e('You can check advanced settings also to improve your results.<br> If you need any help, check the <a href="https://swiftperformance.io/faq/" target="_blank">FAQ</a>, <a href="https://swiftperformance.io/documentation/" target="_blank">Knowledge Base</a>, <a href="https://swiftperformance.io/my-account/support/" target="_blank">Open a support ticket</a>, or join to the <a href="https://www.facebook.com/groups/SwiftPerformanceUsers/" target="_blank">Facebook Community!</a>', 'swift-performance');?></em>
                        </p>
                        <p>
                        	...
                        	<a href="<?php echo esc_url(add_query_arg('subpage', 'settings', menu_page_url(SWIFT_PERFORMANCE_SLUG, false))); ?>" class="swift-btn swift-btn-black"><?php echo sprintf(esc_html__('%s Settings', 'swift-performance'), SWIFT_PERFORMANCE_PLUGIN_NAME); ?></a>
                        	<a href="<?php echo esc_url(menu_page_url(SWIFT_PERFORMANCE_SLUG, false)); ?>" class="swift-btn swift-btn-black"><?php echo sprintf(esc_html__('%s Dashboard', 'swift-performance'), SWIFT_PERFORMANCE_PLUGIN_NAME); ?></a>
                        </p>
                        <p><?php esc_html_e('What\'s next?', 'swift-performance'); ?></p>
                        <div class="swift-setup-row">
                        	<div class="swift-setup-col">
                        		<ul>
                        			<li><a href="https://www.facebook.com/groups/SwiftPerformanceUsers/" target="_blank"><?php esc_html_e('Join to the Facebook Community', 'swift-performance');?></a></li>
