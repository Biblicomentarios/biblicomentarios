...
class Luv_Framework_Option_Fields extends Luv_Framework_Fields {
      ...
      public function __construct($args){
            $this->args = apply_filters('luv_framework_option_args',Luv_Framework::extend($args, array(
                  'option_name'     => '',
                  'menu'            => 'luv-framework',
                  'submenu'         => '',
      ...
      public function render(){
            if (apply_filters('luv_framework_render_options', true, $this)){
                  ...
                  wp_nonce_field('luv-framework-options', 'luv_framework_nonce['.sanitize_title($this->args['nonce_id']).']', true, false);
      ...
      public function save_options($post_id){
            ...
            if (!isset($_POST['luv-action']) || $_POST['luv-action'] != 'save' || !isset($_POST['luv_framework_nonce'][sanitize_title($this->args['nonce_id'])])){
                  return;
            }
            ...
            if (!wp_verify_nonce($_POST['luv_framework_nonce'][sanitize_title($this->args['nonce_id'])], 'luv-framework-options')){
                  wp_send_json(array(
                        'result'     => 'error',
