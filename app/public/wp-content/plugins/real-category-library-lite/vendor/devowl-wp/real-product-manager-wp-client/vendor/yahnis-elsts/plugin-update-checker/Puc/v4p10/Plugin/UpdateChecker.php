...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Plugin_UpdateChecker', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p10_Plugin_UpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_UpdateChecker {
        ...
        public function __construct(
            ...
            $this->extraUi = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Plugin_Ui($this);
        }
        /**
        ...
        protected function createScheduler($checkPeriod) {
            $scheduler = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Scheduler($this, $checkPeriod, [
                'load-plugins.php'
            ]);
        ...
        public function requestUpdate() {
            ...
            $update = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Plugin_Update::fromPluginInfo($pluginInfo);
        ...
        protected function getNoUpdateItemFields() {
            return \array_merge(parent::getNoUpdateItemFields(), [
                'id' => $this->pluginFile,
                'slug' => $this->slug,
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_DebugBar_PluginExtension($this);
        }
        /**
        ...
        protected function createInstalledPackage() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Plugin_Package($this->pluginAbsolutePath, $this);
        }
        /**
