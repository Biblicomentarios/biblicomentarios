...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Vcs_GitLabApi', \false)) {
    class Puc_v4p10_Vcs_GitLabApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Vcs_Api {
        /**
        ...
        public function getLatestCommitTime($ref) {
            $commits = $this->api('/:id/repository/commits/', ['ref_name' => $ref]);
        ...
        public function getRemoteFile($path, $ref = 'master') {
            $response = $this->api('/:id/repository/files/' . $path, ['ref' => $ref]);
