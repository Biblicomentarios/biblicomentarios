...
new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Autoloader();
...
foreach (
    ...
    \DevOwl\RealCategoryLibrary\Vendor\Puc_v4_Factory::addVersion($pucGeneralClass, $pucVersionedClass, '4.10');
    //Also add it to the minor-version factory in case the major-version factory
    //was already defined by another, older version of the update checker.
    \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::addVersion($pucGeneralClass, $pucVersionedClass, '4.10');
}
