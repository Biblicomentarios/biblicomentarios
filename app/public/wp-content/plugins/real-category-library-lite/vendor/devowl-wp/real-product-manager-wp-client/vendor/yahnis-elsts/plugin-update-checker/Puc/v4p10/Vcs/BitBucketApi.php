...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Vcs_BitBucketApi', \false)) {
    class Puc_v4p10_Vcs_BitBucketApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Vcs_Api {
        /**
         ...
         */
        private $repository;
        public function __construct($repositoryUrl, $credentials = []) {
        ...
        protected function getDownloadUrl($ref) {
            return \sprintf('https://bitbucket.org/%s/%s/get/%s.zip', $this->username, $this->repository, $ref);
        }
        /**
        ...
        public function api($url, $version = '2.0') {
            $url = \ltrim($url, '/');
            $isSrcResource = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Utils::startsWith($url, 'src/');
            $url = \implode('/', [
        ...
        public function setAuthentication($credentials) {
            ...
            if (!empty($credentials) && !empty($credentials['consumer_key'])) {
                $this->oauth = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_OAuthSignature(
