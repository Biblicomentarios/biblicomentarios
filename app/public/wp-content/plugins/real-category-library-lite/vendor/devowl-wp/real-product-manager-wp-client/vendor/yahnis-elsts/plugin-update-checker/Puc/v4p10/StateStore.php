...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_StateStore', \false)) {
    class Puc_v4p10_StateStore {
         ...
         * @return $this
         */
        public function setUpdate(\DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Update $update = null) {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        }
        ...
        public function save() {
            ...
            if (isset($this->update)) {
                ...
                if (\DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load() {
            ...
            $this->lastCheck = \intval(\DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Utils::get(
                $state,
                'checkedVersion',
                ''
            );
