...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Theme_UpdateChecker', \false)) {
    class Puc_v4p10_Theme_UpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_UpdateChecker {
        ...
        protected function getNoUpdateItemFields() {
            return \array_merge(parent::getNoUpdateItemFields(), ['theme' => $this->directoryName, 'requires' => '']);
        }
        ...
        protected function createScheduler($checkPeriod) {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Scheduler($this, $checkPeriod, ['load-themes.php']);
        }
        /**
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_DebugBar_Extension(
                $this,
                'Puc_v4p10_DebugBar_ThemePanel'
            );
        }
        /**
        ...
        protected function createInstalledPackage() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Theme_Package($this->stylesheet, $this);
        }
    }
}
