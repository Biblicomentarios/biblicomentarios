...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Plugin_Package', \false)) {
    class Puc_v4p10_Plugin_Package extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_InstalledPackage {
        /**
        ...
        public function getPluginTitle() {
            ...
            if ($header && !empty($header['Name']) && isset($header['TextDomain'])) {
                $title = \translate($header['Name'], $header['TextDomain']);
            }
            return $title;
        }
        /**
        ...
        public function isMuPlugin() {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    $muPluginDir = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::normalizePath(
                        \WPMU_PLUGIN_DIR
                    );
                    $pluginPath = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::normalizePath(
