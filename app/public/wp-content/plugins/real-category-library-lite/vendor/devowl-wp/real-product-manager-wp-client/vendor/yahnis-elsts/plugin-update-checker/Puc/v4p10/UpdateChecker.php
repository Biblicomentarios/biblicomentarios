...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_UpdateChecker', \false)) {
    abstract class Puc_v4p10_UpdateChecker {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
            ...
            $this->upgraderStatus = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_UpgraderStatus();
            $this->updateState = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_StateStore($this->optionName);
            if (\did_action('init')) {
                $this->loadTextDomain();
            } else {
        ...
        protected function installHooks() {
            ...
            \add_action('delete_site_transient_' . $this->updateTransient, [$this, 'clearCachedTranslationUpdates']);
            ...
            if (\did_action('plugins_loaded')) {
                ...
                \add_action('plugins_loaded', [$this, 'maybeInitDebugBar']);
            }
        }
        /**
        ...
        public function removeHooks() {
            ...
            \remove_action('delete_site_transient_' . $this->updateTransient, [$this, 'clearCachedTranslationUpdates']);
            ...
            \remove_action('plugins_loaded', [$this, 'maybeInitDebugBar']);
        ...
        public function allowMetadataHost($allow, $host) {
            ...
            if (
                \is_string($this->cachedMetadataHost) &&
                \strtolower($host) === \strtolower($this->cachedMetadataHost)
            ) {
                return \true;
            }
            return $allow;
         ...
         */
        protected function fixSupportedWordpressVersion(
            \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Metadata $update = null
        ) {
        ...
        protected function getNoUpdateItemFields() {
            return ['new_version' => $this->getInstalledVersion(), 'url' => '', 'package' => '', 'requires_php' => ''];
        }
        /**
         ...
         */
        protected function requestMetadata($metaClass, $filterRoot, $queryArgs = []) {
        ...
        protected function filterApplicableTranslations($translations) {
            ...
            foreach ($translations as $translation) {
                ...
                if (isset($installedTranslations[$translation->language])) {
                    ...
                    $installedTimestamp = \strtotime(
                        $installedTranslations[$translation->language]['PO-Revision-Date']
                    );
        ...
        public function injectTranslationUpdates($updates) {
            ...
            $updates->translations = \array_values(
                \array_filter($updates->translations, [$this, 'isNotMyTranslation'])
            );
        ...
        protected function isNotMyTranslation($translation) {
            $isMatch =
                isset($translation['type'], $translation['slug']) &&
        ...
        public function fixDirectoryName($source, $remoteSource, $upgrader) {
            ...
            $correctedSource = \trailingslashit($remoteSource) . $this->directoryName . '/';
            if ($source !== $correctedSource) {
                ...
                if ($wp_filesystem->move($source, $correctedSource, \true)) {
        ...
        protected function isBadDirectoryStructure($remoteSource) {
            ...
            if (\is_array($sourceFiles)) {
                ...
                $firstFilePath = \trailingslashit($remoteSource) . $sourceFiles[0];
        ...
        public function maybeInitDebugBar() {
            if (
                \class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Debug_Bar', \false) &&
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_DebugBar_Extension($this);
        }
        /**
