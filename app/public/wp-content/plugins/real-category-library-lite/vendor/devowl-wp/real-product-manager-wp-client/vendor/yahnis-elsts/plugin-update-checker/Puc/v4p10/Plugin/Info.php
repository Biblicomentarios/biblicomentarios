...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Plugin_Info', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p10_Plugin_Info extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Metadata {
        ...
        public function toWpFormat() {
            ...
            if (!empty($this->banners)) {
                ...
                $info->banners = \array_intersect_key($info->banners, ['high' => \true, 'low' => \true]);
            }
            return $info;
        }
