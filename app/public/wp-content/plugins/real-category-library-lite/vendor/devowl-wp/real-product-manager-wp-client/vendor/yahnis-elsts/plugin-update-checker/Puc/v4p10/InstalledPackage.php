...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_InstalledPackage', \false)) {
    /**
    ...
    abstract class Puc_v4p10_InstalledPackage {
        ...
        public function fileExists($relativeFileName) {
            return \is_file(
                $this->getAbsoluteDirectoryPath() . \DIRECTORY_SEPARATOR . \ltrim($relativeFileName, '/\\')
            );
        }
        /* -------------------------------------------------------------------
         * File header parsing
