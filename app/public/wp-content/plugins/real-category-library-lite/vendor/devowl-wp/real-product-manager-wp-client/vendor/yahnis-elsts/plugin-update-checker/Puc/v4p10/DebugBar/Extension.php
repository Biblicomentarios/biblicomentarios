...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_DebugBar_Extension', \false)) {
    class Puc_v4p10_DebugBar_Extension {
        ...
        public function enqueuePanelDependencies() {
            ...
            \wp_enqueue_script('puc-debug-bar-js-v4', $this->getLibraryUrl('/js/debug-bar.js'), ['jquery'], '20170516');
        }
        /**
        ...
        private function getLibraryUrl($filePath) {
            ...
            $absolutePath = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::normalizePath($absolutePath);
            $pluginDir = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::normalizePath(\WP_PLUGIN_DIR);
            $muPluginDir = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::normalizePath(\WPMU_PLUGIN_DIR);
            $themeDir = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Factory::normalizePath(\get_theme_root());
