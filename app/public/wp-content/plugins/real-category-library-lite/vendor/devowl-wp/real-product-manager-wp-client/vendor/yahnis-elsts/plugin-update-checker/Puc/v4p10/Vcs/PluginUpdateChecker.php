...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Vcs_PluginUpdateChecker')) {
    class Puc_v4p10_Vcs_PluginUpdateChecker
        extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Plugin_UpdateChecker
        ...
        public function requestInfo($unusedParameter = null) {
            ...
            $info = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Plugin_Info();
            ...
            if (empty($info->sections['changelog'])) {
                $info->sections['changelog'] = $api->getRemoteChangelog(
                    $ref,
                    $this->package->getAbsoluteDirectoryPath()
                );
                if (empty($info->sections['changelog'])) {
