...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p10_Theme_Update', \false)) {
    class Puc_v4p10_Theme_Update extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p10_Update {
        public $details_url = '';
        protected static $extraFields = ['details_url'];
        /**
        ...
        public function toWpFormat() {
            $update = ['theme' => $this->slug, 'new_version' => $this->version, 'url' => $this->details_url];
