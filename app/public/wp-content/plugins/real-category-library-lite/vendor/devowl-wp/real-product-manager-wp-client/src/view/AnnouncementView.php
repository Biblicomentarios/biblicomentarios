...
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement;
...
class AnnouncementView {
                ...
                echo \sprintf(
                    ...
                    $a->isDismissible()
                        ? \sprintf(
                            ...
                            esc_js($this->dismissOnClickHandler($a)),
                            __('Dismiss', RPM_WP_CLIENT_TD)
                        )
                        : ''
                );
            } else {
    ...
    protected function img($a) {
        ...
        $img = \sprintf(
            '<img %s style="max-width: 100%%; height: auto; display: block; margin: 10px 0;" />',
            $this->srcset($a)
        );
    ...
    public static function instance($pool) {
        return new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealProductManagerWpClient\view\AnnouncementView($pool);
    }
}
