...
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler;
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary;
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary;
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner;
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia;
use DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\view\Options;
...
class Core {
    ...
    private function __construct() {
        $this->ratingHandler = \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\RatingHandler::instance($this);
        $this->crossSellingHandler = \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler::instance(
            $this
        );
        $this->assets = \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Assets::instance();
        \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\view\Options::instance();
        add_action('rest_api_init', [
            \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Service::instance(),
            'rest_api_init'
        ]);
        ...
        $this->crossSelling[
            \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner::SLUG
        ] = new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner();
        $this->crossSelling[
            \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary::SLUG
        ] = new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary();
        $this->crossSelling[
            \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary::SLUG
        ] = new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary();
        $this->crossSelling[
            \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia::SLUG
        ] = new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia();
    }
    /**
     * Add an initiator.
     *
    ...
    public static function getInstance() {
        return !isset(self::$me)
            ? (self::$me = new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Core())
            : self::$me;
    }
}
