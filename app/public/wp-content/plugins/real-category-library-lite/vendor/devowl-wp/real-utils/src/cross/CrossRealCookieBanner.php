 ...
 */
class CrossRealCookieBanner extends \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\cross\AbstractCrossSelling {
    ...
    public function hasGdprPluginInstalled($plugins) {
        foreach ($plugins as $slug) {
            $file = \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Core::getInstance()
