...
class WelcomePage {
    ...
    <div class="about-wrap-content">
        ...
        $data = [
            ...
            '%subtitle' => \str_replace(
                ...
                \sprintf(
                    '<br /><cite>',
                    \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Core::getInstance()->getBaseAssetsUrl(
                        'devowl.io-logo.svg'
                    )
                ),
        ...
        return is_admin() &&
            ...
            $_GET['page'] ===
                $this->getInitiator()->getPluginSlug() .
                    \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\WelcomePage::PAGE_SUFFIX;
    }
    /**
     * Create instance.
     *
    ...
    public static function instance($initiator) {
        return new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\WelcomePage($initiator);
    }
}
