...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        $ratingHandler = \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Core::getInstance()->getRatingHandler();
        ...
        return [
            ...
            'cross' => \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Core::getInstance()
    ...
    public static function instance() {
        return new \DevOwl\RealCategoryLibrary\Vendor\DevOwl\RealUtils\Assets();
    }
}
