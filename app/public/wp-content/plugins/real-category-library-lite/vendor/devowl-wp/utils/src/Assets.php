    ...
    public function localizeScript($context) {
        ...
        return [
            ...
            'restUrl' => $this->getAsciiUrl(
                \DevOwl\RealCategoryLibrary\Vendor\MatthiasWeb\Utils\Service::getUrl($this)
            ),
            'restNamespace' => \DevOwl\RealCategoryLibrary\Vendor\MatthiasWeb\Utils\Service::getNamespace($this),
...
',
    ...
    public function getChunkTranslationMap() {
        $path =
            $this->getPluginConstant(
                \DevOwl\RealCategoryLibrary\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_INC
