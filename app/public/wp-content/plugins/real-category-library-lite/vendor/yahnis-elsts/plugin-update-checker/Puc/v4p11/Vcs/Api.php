...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_Api')) {
    abstract class Puc_v4p11_Vcs_Api {
        ...
        public function getRemoteReadme($ref = 'master') {
            ...
            $parser = new \DevOwl\RealCategoryLibrary\Vendor\PucReadmeParser();
        ...
        protected function sortTagsByVersion($tags) {
            ...
            $versionTags = \array_filter($tags, [$this, 'isVersionTag']);
        ...
        public function getRemoteChangelog($ref, $localDirectory) {
            ...
            return \DevOwl\RealCategoryLibrary\Vendor\Parsedown::instance()->text($changelog);
        }
        /**
        ...
        protected function findChangelogName($directory = null) {
            ...
            $possibleNames = ['CHANGES.md', 'CHANGELOG.md', 'changes.md', 'changelog.md'];
