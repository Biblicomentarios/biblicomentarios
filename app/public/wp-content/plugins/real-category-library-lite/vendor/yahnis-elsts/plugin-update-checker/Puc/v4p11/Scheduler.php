...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Scheduler', \false)) {
    /**
    ...
    class Puc_v4p11_Scheduler {
        ...
        public function upgraderProcessComplete(
            ...
            if (\is_a($this->updateChecker, 'DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Theme_UpdateChecker')) {
            ...
            if (\is_a($this->updateChecker, 'DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Plugin_UpdateChecker')) {
