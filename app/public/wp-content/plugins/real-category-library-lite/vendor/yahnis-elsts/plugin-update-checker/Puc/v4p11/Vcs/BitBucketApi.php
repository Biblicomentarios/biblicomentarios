...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_BitBucketApi', \false)) {
    class Puc_v4p11_Vcs_BitBucketApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Api {
        /**
        ...
        public function api($url, $version = '2.0') {
            $url = \ltrim($url, '/');
            $isSrcResource = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Utils::startsWith($url, 'src/');
            $url = \implode('/', [
        ...
        public function setAuthentication($credentials) {
            ...
            if (!empty($credentials) && !empty($credentials['consumer_key'])) {
                $this->oauth = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_OAuthSignature(
