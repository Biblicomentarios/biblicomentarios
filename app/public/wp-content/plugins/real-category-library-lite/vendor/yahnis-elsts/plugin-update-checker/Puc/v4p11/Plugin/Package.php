...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Plugin_Package', \false)) {
    class Puc_v4p11_Plugin_Package extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_InstalledPackage {
        /**
        ...
        public function isMuPlugin() {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    $muPluginDir = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Factory::normalizePath(
                        \WPMU_PLUGIN_DIR
                    );
                    $pluginPath = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Factory::normalizePath(
