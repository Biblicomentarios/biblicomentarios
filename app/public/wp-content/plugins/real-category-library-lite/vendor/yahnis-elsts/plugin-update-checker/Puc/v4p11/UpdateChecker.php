...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_UpdateChecker', \false)) {
    abstract class Puc_v4p11_UpdateChecker {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
            ...
            $this->upgraderStatus = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_UpgraderStatus();
            $this->updateState = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_StateStore($this->optionName);
            if (\did_action('init')) {
                $this->loadTextDomain();
            } else {
        ...
        protected function fixSupportedWordpressVersion(
            \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Metadata $update = null
        ) {
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_DebugBar_Extension($this);
        }
        /**
