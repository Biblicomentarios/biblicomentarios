...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Theme_UpdateChecker', \false)) {
    class Puc_v4p11_Theme_UpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_UpdateChecker {
        ...
        protected function createScheduler($checkPeriod) {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, ['load-themes.php']);
        }
        /**
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_DebugBar_Extension(
                $this,
                'Puc_v4p11_DebugBar_ThemePanel'
            );
        }
        /**
        ...
        protected function createInstalledPackage() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Theme_Package($this->stylesheet, $this);
        }
    }
}
