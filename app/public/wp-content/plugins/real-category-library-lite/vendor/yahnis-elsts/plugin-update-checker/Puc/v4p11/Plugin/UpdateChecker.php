...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Plugin_UpdateChecker', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p11_Plugin_UpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_UpdateChecker {
        ...
        public function __construct(
            ...
            $this->extraUi = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Plugin_Ui($this);
        }
        /**
        ...
        protected function createScheduler($checkPeriod) {
            $scheduler = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, [
                'load-plugins.php'
            ]);
        ...
        public function requestUpdate() {
            ...
            $update = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Plugin_Update::fromPluginInfo($pluginInfo);
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_DebugBar_PluginExtension($this);
        }
        /**
        ...
        protected function createInstalledPackage() {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Plugin_Package($this->pluginAbsolutePath, $this);
        }
        /**
