...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_UpgraderStatus', \false)) {
    /**
    ...
    class Puc_v4p11_UpgraderStatus {
        ...
        //Plugin basename or theme directory name.
        public function __construct() {
            //Keep track of which plugin/theme WordPress is currently upgrading.
            \add_filter('upgrader_pre_install', [$this, 'setUpgradedThing'], 10, 2);
            \add_filter('upgrader_package_options', [$this, 'setUpgradedPluginFromOptions'], 10, 1);
            \add_filter('upgrader_post_install', [$this, 'clearUpgradedThing'], 10, 1);
            \add_action('upgrader_process_complete', [$this, 'clearUpgradedThing'], 10, 1);
        }
        /**
        ...
        private function getThingBeingUpgradedBy($upgrader) {
            ...
            if ($pluginFile !== null) {
                ...
                return ['theme', $themeDirectoryName];
            }
            return [null, null];
        }
        /**
