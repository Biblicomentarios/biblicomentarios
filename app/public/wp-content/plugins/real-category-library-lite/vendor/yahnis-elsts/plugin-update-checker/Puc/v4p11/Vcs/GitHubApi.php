...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_GitHubApi', \false)) {
    class Puc_v4p11_Vcs_GitHubApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Api {
        /**
        ...
        public function getLatestRelease() {
            ...
            $reference = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference([
        ...
        public function getLatestTag() {
            ...
            $tag = $versionTags[0];
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference([
                'name' => $tag->name,
