 ...
 */
class CrossRealCategoryLibrary extends \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\cross\AbstractCrossSelling {
    ...
    public function skip() {
        $handler = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()->getCrossSellingHandler();
    ...
    public function getMeta() {
        return [
            'add-category' => [
                ...
                'description' => __(
                    'Do you still create your categories this way? Get an explorer-like tree view directly in your posts/page table!',
                    REAL_UTILS_TD
                ),
                'link' => self::PRO_LINK
            ],
            'add-wc-category' => [
                ...
                'description' => __(
                    'Do you still create your product categories and attributes this way? Get an explorer-like tree view directly to your WooCommerce products table!',
                    REAL_UTILS_TD
                ),
                'link' => self::PRO_LINK
            ],
