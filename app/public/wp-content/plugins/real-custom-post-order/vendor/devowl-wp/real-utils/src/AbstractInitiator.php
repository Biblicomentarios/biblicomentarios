...
use DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\Utils\Base;
use DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\Utils\Assets;
...
abstract class AbstractInitiator {
    ...
    public function start() {
        \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()->addInitiator($this);
        $this->welcomePage = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\WelcomePage::instance($this);
