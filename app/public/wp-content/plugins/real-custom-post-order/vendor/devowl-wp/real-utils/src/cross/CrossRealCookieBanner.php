 ...
 */
class CrossRealCookieBanner extends \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\cross\AbstractCrossSelling {
    ...
    public function getMeta() {
        return [
            'gdpr-compliant' => [
                ...
                'description' => __(
                    'Websites targeting users from the EU and setting non-essential cookies require an opt-in cookie banner. We recommend Real Cookie Banner as ePrivacy Directive and GDPR compliant solution for WordPress.',
                    REAL_UTILS_TD
                ),
    ...
    public function hasGdprPluginInstalled($plugins) {
        foreach ($plugins as $slug) {
            $file = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()
