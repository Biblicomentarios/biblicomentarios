...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        $ratingHandler = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()->getRatingHandler();
        ...
        return [
            ...
            'cross' => \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()
    ...
    public static function instance() {
        return new \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Assets();
    }
}
