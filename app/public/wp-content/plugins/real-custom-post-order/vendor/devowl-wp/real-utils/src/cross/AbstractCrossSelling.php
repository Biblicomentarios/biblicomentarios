...
namespace DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\cross;

use DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\UtilsProvider;
use DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core;
use DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler;
...
abstract class AbstractCrossSelling {
    ...
    public function getAssetsUrl($path = '') {
        return \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()->getBaseAssetsUrl(
    ...
    public function actionCounter($action, $increment = \false) {
        $optionName =
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_CROSS_COUNTER .
            '.' .
            $this->getSlug() .
            '.' .
            $action;
        $cnt = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::get(
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
            $optionName,
            0
        );
        if ($increment) {
            $cnt++;
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::set(
                \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
                $optionName,
                $cnt
            );
    ...
    public function forceHide($action, $force = \false) {
        $skip = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::get(
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_CROSS_SKIP,
            []
        );
        if ($force) {
    ...
    public function dismiss($action, $force) {
        ...
        $ts = \strtotime(
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()
        ...
        if (
            \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::set(
                \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
                \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_NEXT_CROSS_SELLING,
                $ts
            )
        ) {
            return $ts;
