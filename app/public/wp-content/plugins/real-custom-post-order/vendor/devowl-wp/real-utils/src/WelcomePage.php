...
class WelcomePage {
    ...
    public function activated_plugin($plugin) {
        ...
        if (!$fromBulkAction && !$isWpCli && $plugin === plugin_basename($this->getInitiator()->getPluginFile())) {
            $alreadyRedirected = \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::get(
                $this->getInitiator(),
                \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE,
                \false
            );
    ...
    <div class="about-wrap-content">
        ...
        $data = [
            ...
            '%subtitle' => \str_replace(
                ...
                \sprintf(
                    '<br /><cite>',
                    \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\Core::getInstance()->getBaseAssetsUrl(
                        'devowl.io-logo.svg'
                    )
                ),
        ...
        return is_admin() &&
            ...
            $_GET['page'] ===
                $this->getInitiator()->getPluginSlug() .
                    \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\WelcomePage::PAGE_SUFFIX;
    }
    /**
     * Create instance.
     *
    ...
    public static function instance($initiator) {
        return new \DevOwl\RealCustomPostOrder\Vendor\DevOwl\RealUtils\WelcomePage($initiator);
    }
}
