    ...
    public function localizeScript($context) {
        ...
        return [
            ...
            'restUrl' => $this->getAsciiUrl(
                \DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\Utils\Service::getUrl($this)
            ),
            'restNamespace' => \DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\Utils\Service::getNamespace($this),
...
',
    ...
    public function getChunkTranslationMap() {
        $path =
            $this->getPluginConstant(
                \DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_INC
            ) . '/base/others/cachebuster.php';
        $result = ['_' => '_'];
        if (\file_exists($path)) {
