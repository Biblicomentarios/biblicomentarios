...
namespace DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\WpdbBatch;

/**
 * Batch update implementation.
 */
class Update extends \DevOwl\RealCustomPostOrder\Vendor\MatthiasWeb\WpdbBatch\AbstractBatch {
    /**
