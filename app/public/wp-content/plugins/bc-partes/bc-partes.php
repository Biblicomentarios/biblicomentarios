...
function librosAntiguoTestamento()
{
    ...
    // asignarCategoriaPadre('El establecimiento de Salomón como rey','1 Reyes',1,2); 
    // asignarCategoriaPadre('El ascenso de Salomón como rey','1 Reyes',3,8); 
    // asignarCategoriaPadre('El declive de Salomón como rey','1 Reyes',9,11); 
    // asignarCategoriaPadre('La división del reino','1 Reyes',12,14); 
    // asignarCategoriaPadre('Los reinados de tres reyes en Judá y siete en Israel','1 Reyes',15,22); 
    ...
    // asignarPapa('El dilema de Job','Introducción del dilema de Job');
    // asignarCategoriaPadre('Introducción del dilema de Job','Job',1,2);
    ...
    // asignarCategoriaPadre('La solución de Elihú','Job',32,37);
    // asignarPapa('Job','La redención de Job');
